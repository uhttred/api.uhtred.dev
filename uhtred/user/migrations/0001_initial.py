    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('collaborator', 'collaborator'), ('member', 'member')], default='member', max_length=12, verbose_name='role')),
        ...
        migrations.CreateModel(
            ...
            bases=('user.user',),
            managers=[
                ('objects', uhtred.user.models.user.MemberManager()),
            ],
        ),
        migrations.CreateModel(
            name='Member',
